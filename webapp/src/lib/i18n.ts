...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    txt_master_password_must_be_at_least_chars: "Master password must be at least {min} characters",
    txt_master_password_min_length_hint: "Use at least {min} characters.",
    ...
    txt_new_password_must_be_at_least_chars: "New password must be at least {min} characters",
...
const zhCNOverrides: Record<string, string> = {
  ...
  txt_master_password_must_be_at_least_chars: '主密码至少需要 {min} 个字符',
  txt_master_password_min_length_hint: '请至少输入 {min} 个字符。',
  txt_moved_selected_items: '已移动所选项目',
  txt_name_is_required: '名称不能为空',
  txt_new_password_must_be_at_least_chars: '新密码至少需要 {min} 个字符',
