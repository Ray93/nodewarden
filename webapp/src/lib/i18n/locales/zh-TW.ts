...
const zhTW: Record<string, string> = {
  ...
  "txt_master_password_must_be_at_least_chars": "主密碼至少需要 {min} 個字符",
  "txt_master_password_min_length_hint": "請至少輸入 {min} 個字符。",
  ...
  "txt_new_password_must_be_at_least_chars": "新密碼至少需要 {min} 個字符",
