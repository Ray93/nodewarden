...
const ru: Record<string, string> = {
  ...
  "txt_master_password_must_be_at_least_min_chars": "Мастер-пароль должен содержать не менее {min} символов.",
  ...
  "txt_new_password_must_be_at_least_min_chars": "Новый пароль должен содержать не менее {min} символов.",
