...
const ru: Record<string, string> = {
  ...
  "txt_master_password_must_be_at_least_chars": "Мастер-пароль должен содержать не менее {min} символов.",
  "txt_master_password_min_length_hint": "Используйте не менее {min} символов.",
  ...
  "txt_new_password_must_be_at_least_chars": "Новый пароль должен содержать не менее {min} символов.",
